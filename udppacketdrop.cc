...
int main (int argc, char *argv[]) {
    ...
    p2p.SetQueue ("ns3::DropTailQueue<Packet>", "MaxSize", QueueSizeValue (QueueSize ("2p")));
    ...
    uint16_t port = 9;
    OnOffHelper source ("ns3::UdpSocketFactory", InetSocketAddress (i23.GetAddress (1), port));
    source.SetAttribute ("DataRate", StringValue ("50Mbps"));
